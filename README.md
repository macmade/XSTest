...
[![Build Status](https://img.shields.io/github/workflow/status/macmade/XSTest/ci-mac?label=macOS&logo=apple)](https://github.com/macmade/XSTest/actions/workflows/ci-mac.yaml)
[![Build Status](https://img.shields.io/github/workflow/status/macmade/XSTest/ci-win?label=Windows&logo=windows)](https://github.com/macmade/XSTest/actions/workflows/ci-win.yaml)
